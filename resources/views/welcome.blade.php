...
@section('content')
    <div class="container pt-5">
        <div class="row">
            ...
            <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter" id="filter-form">
                <h3 class="mt-0 mb-5">Produkty <span id="products-count" class="text-primary">{{count($products)}}</span> </h3>
                ...
                <div class="divider mt-5 mb-5 border-bottom border-secondary"></div>
                <a href="#" class="btn btn-lg btn-block btn-primary mt-5" id="filter-button"><i class="fa-solid fa-magnifying-glass"></i> Filtruj</a>
            </form>
